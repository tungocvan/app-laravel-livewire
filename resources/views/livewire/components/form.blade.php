    ...
    <div class="col-md-6">
        <div class="card p-2">
            ...
            <div class="card-footer">
                Visit <a href="https://github.com/Johann-S/bs-stepper/#how-to-use-it">documentation</a> for more examples and information about the plugin.
            </div>
        </div>
        <!-- /.card -->
    </div>
          ...
          <div id="actions" class="row">
            <div class="col-lg-6">
              <div class="btn-group w-100">
                ...
                <button type="submit" class="btn btn-primary col start" fdprocessedid="ooz8bc">
                  <i class="fas fa-upload"></i>
                  <span>Start upload</span>
                </button>
                <button type="reset" class="btn btn-warning col cancel" fdprocessedid="7l98mf">
