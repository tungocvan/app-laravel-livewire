...
class RoleController extends Controller
{
    ...
    public function permission(): View
    {
        ...
        $modules = [];
        foreach($directoryNames as $value){
            $exists = Permission::where('name', 'like', "$value%")->exists();
            if (!$exists) {
                $modules[] = $value;
            }
        }
        return view('roles.permission',compact('modules'));
    }
    ...
    public function storePermission(Request $request): RedirectResponse
    {
        ...
        // dd($request->module);
        if($request->module){
            $name = strtolower($request->module);
            $permissionsArray = [
                $name.'-list',
                $name.'-create',
                $name.'-edit',
        ...
        return redirect()->route('roles.index')
                        ->with('faile','Permission Module exits');
    }
